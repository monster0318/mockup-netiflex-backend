...
@Component({
  selector: "app-log-in",
  standalone: true,
  imports: [FormsModule, FooterComponent, NavBarComponent, CommonModule, WrapperComponent, RouterLink],
...
export class LogInComponent implements OnInit {
  ...
  resetForm() {
    (this.password = ""), (this.email = ""), (this.rememberMe = false);
  }

  onLogin() {
    this.requestsService
      .postData("login/", { email: this.email, password: this.password }, this.apiService.getUnAuthHeaders(), () => {
